...
<ScrollView >
  <Modal transparent={true} animationType='slide' visible={modalVisibleplaya} onRequestClose={() => {
    ...
    <View style={styles.vistaModal}>
      <View style={styles.Modal}>
        <Text style={styles.subtitulo}>Hotel San Esteban</Text>
        <Text>El Salvador, contamos con 10 años de experiencia</Text>
 ...
 <View style={styles.contenedor}>
  <Text style={styles.titulo}>Contamos con tres tipos de habitaciones</Text>
  ...
  <View style={styles.listado}>
    ...
    <View style={styles.listaItem}>
      <Image 
        style={styles.mejores}
        source={require('./src/img/mejores2.jpeg')}/>
    </View>
    ...
    <View style={styles.listaItem}>
      <Image 
        style={styles.mejores}
        source={require('./src/img/mejores4.jpg')}/>
    </View>
  </View>

  <Text style={styles.titulo}>Rutas Turisticas cercanas</Text>
  <View>
    <View>
      <Image 
        style={styles.mejores}
